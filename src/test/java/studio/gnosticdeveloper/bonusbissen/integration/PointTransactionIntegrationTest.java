...
//     private HttpEntity<ExchangeCreateRequest> authed(String token, ExchangeCreateRequest body) {
...
//                 authed(token, new ExchangeCreateRequest(customer.getDocument(), TransactionType.PURCHASE, menuItem.getId(), null, null, null)),
...
//         ResponseEntity<ExchangeResponse> redemption = restTemplate.exchange(
//                 baseUrl() + "/point-transactions", org.springframework.http.HttpMethod.POST,
//                 authed(token, new ExchangeCreateRequest(customer.getDocument(), TransactionType.REDEMPTION, null, reward.getId(), null, null)),
//                 ExchangeResponse.class);
