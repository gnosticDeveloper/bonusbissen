...
export default function EliminarPerfilModal({ onCancel, onConfirm }: EliminarPerfilModalProps) {
  return (
    <Modal onCloseAction={onCancel} align="end" labelledBy="eliminar-perfil-title" className="w-full max-w-sm rounded-3xl bg-cream p-6 flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-3">
        <h2 id="eliminar-perfil-title" className="text-2xl font-bold text-ink">¿Eliminar tu perfil?</h2>
